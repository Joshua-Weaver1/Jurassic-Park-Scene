...
# The camera is defined by a view matrix V.
# The view matrix is the inverse of the camera matrix.
# The camera matrix is defined by the position of the camera and the direction it is looking at.
...
class Camera:
    ...
    def __init__(self):
        ...
        self.center = [0, 20, 0.]  # position of the centre
    ...
    def update(self):
        ...
        # finally we calculate the view matrix by combining the three matrices in the correct order
